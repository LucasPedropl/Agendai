...
export default function AdminProfissionaisPage() {
  ...
  useEffect(() => {
    setTimeout(() => {
      setProfissionais([
        { id: '1', nome: 'João Silva', email: 'joao@barbearia.com', telefone: '(11) 99999-1111', especialidades: ['Corte', 'Barba'], ativo: true },
        { id: '2', nome: 'Pedro Souza', email: 'pedro@barbearia.com', telefone: '(11) 99999-2222', especialidades: ['Barba', 'Sobrancelha'], ativo: true },
      ]);
      setIsLoading(false);
    }, 1000);
  }, []);
